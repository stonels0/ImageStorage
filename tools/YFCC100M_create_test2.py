...
# @Last Modified time: 2018-06-14 10:38:06
import os,os.path
import sys
...
def manipulate_from_folders(imgRoot,annRoot):
    ...
    imgroot = imgRoot
    annroot = annRoot
    desroot = 'E:/Lishi/Datasets/DataSets_release/YFCC100M/Image_test2'
    #把已经入库的图像放到这个文件夹里面
...
if __name__ == '__main__':
    ...
    dirpath = 'E:/Lishi/Datasets/DataSets_release/YFCC100M/test_2/'
